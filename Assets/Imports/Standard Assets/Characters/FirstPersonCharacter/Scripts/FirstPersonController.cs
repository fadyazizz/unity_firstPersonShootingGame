...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (PlayerPrefs.GetString("character") == "Bangalor")
            {
                m_RunSpeed *= 2;
            }
        ...
        private void Update()
        {
            ...
            // the jump state needs to read here to make sure it is not missed
            m_Crouch = (Input.GetKeyDown(KeyCode.C) || Input.GetKeyDown(KeyCode.LeftControl)) && !Input.GetKey(KeyCode.LeftShift);
            ScaleCapsuleForCrouching(m_Crouch);
        ...
        private void PlayLandingSound()
        {
            ...
            if (PlayerPrefs.GetFloat("effectsValue") != 0.0f)
            {
                AudioManager.instance.Stop("EnemyFoot");
        ...
        public void rotateViewMyImplementation(GameObject enemy)
        {
            transform.LookAt(enemy.transform);
            //transform.eulerAngles += new Vector3(-10, 0, 0);
            m_Camera.transform.LookAt(enemy.transform);
            //m_Camera.transform.eulerAngles += new Vector3(-10,0,0);
            m_MouseLook.LookRotationMyImplementation(m_Camera.transform.localRotation, transform.localRotation);
            //m_MouseLook.LookRotationMyImplementation(transform, m_Camera.transform, rotation);
        }
        ...
        private void FixedUpdate()
        {
            ...
            {
                if (m_Jump && PlayerPrefs.GetString("character") == "BloodHound")
                {
                    m_MoveDir.y = m_JumpSpeed;
                    PlayJumpSound();
                    //AudioManager.instance.Play("Jump");
        ...
        private void PlayFootStepAudio()
        {
            ...
            //}
            AudioManager.instance.Stop("EnemyFoot");
            AudioManager.instance.Play("PlayerFoot");
